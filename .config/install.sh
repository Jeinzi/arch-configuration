...
# Installation
sudo pacman -S i3 xfce4-terminal git zsh compton lxappearance scrot sshfs firefox rofi thunderbird thunar veracrypt inkscape feh gimp texlive-most texmaker arc-gtk-theme alsa-utils nm-applet gst-libav mplayer
...
# AUR installations
yaourt -S i3blocks moka-icon-theme thefuck spotify staruml illum-git playerctl arduino eagle shutter dropbox --noconfirm
